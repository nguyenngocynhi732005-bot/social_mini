...
<div id="profile-page-data"
    ...
    data-current-cover-url="{{ $currentCoverUrl ?? '' }}"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (profilePageData && profilePageData.dataset.profileStoryItems) {
        try {
            profileStoryItems = JSON.parse(profilePageData.dataset.profileStoryItems);
        } catch (error) {
            profileStoryItems = [];
        }
    }
    var updateAccountUrl = profilePageData ? (profilePageData.dataset.updateAccountUrl || '') : '';
    var updateIntroUrl = profilePageData ? (profilePageData.dataset.updateIntroUrl || '') : '';
    ...
    function handleAccountSave() {
        ...
        axios.post(updateAccountUrl, payload, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'X-CSRF-TOKEN': csrfToken ? csrfToken.getAttribute('content') : '',
                'Content-Type': 'application/json'
    ...
    function handleIntroSave() {
        ...
        axios.post(updateIntroUrl, payload, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'X-CSRF-TOKEN': csrfToken ? csrfToken.getAttribute('content') : '',
                'Content-Type': 'application/json'
